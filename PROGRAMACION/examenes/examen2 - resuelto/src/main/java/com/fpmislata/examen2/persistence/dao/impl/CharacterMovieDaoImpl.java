...
public class CharacterMovieDaoImpl implements CharacterMovieDao {
    ...
    public CharacterMovieEntity findById(Integer id) {
        for (CharacterMovieEntity characterMovieEntity : characterMovieEntityList){
            if (id == characterMovieEntity.getId()){
    ...
    public List<CharacterMovieEntity> findByMovie(Integer id){
        List<CharacterMovieEntity> moviesCharacter = new ArrayList<>();
        for (CharacterMovieEntity characterMovieEntity : characterMovieEntityList){
            if (id == characterMovieEntity.getMovieId()){
                moviesCharacter.add(characterMovieEntity);
            }
        }
